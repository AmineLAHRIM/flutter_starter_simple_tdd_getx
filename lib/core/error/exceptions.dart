...
RemoteException({required DioError e, List<RemoteMessageError>? rmerrors, bool skipTokenException = false}) {
  if (e.error == SocketException) {
    throw SocketException(Messages.NO_CONNECTION);
  }
  ...
  if (responseData['code'] != null) {
    ...
    if (skipTokenException == false && responseData['code'] == 16) {
      ...
      var index = rmerrors!.indexWhere((element) => responseData['code'] == element.code);
